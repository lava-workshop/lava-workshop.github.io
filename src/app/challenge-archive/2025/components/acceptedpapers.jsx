    ...
    return (
        <div className="text-justify">
            <ul className="list-disc list-inside space-y-2 mt-2 ml-4">
                <li>(Summary paper) Daichi Sato, Duc Minh Vo, Khan Md. Anwarus Salam, Hidenori Shoji, Yuma Matsuoka, Takara Taniguchi, Kaito Baba, Hideki Nakayama: LAVA Challenge 2025: Advancing Japanese Document Understanding with a Challenging PDF-VQA Benchmark (Challenge Summary Paper)</li>
                ...
                <li>(3rd Prize, nsbsk team) Ao Zhou, Zebo Gu, Tenghao Sun, Jiawen Chen, Mingsheng Tu, Zifeng Cheng, Yafeng Yin, Zhiwei Jiang, Qing Gu: Hierarchical Vision-Language Reasoning for Multimodal Multiple-Choice Question Answering</li>
